...
import bucket_resolvers
import organization_resolvers
...
# returns bucket info
@app.route(f'/api/{API_VERSION}/bucket', methods=['POST'])
def create_bucket_for_host():
    ...
    retention = data['retention']  # retention of data (in seconds)
